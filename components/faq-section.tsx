          ...
          <div className="lg:col-span-1">
            <div className="bg-card border border-border rounded-2xl p-8 text-center sticky top-8">
              ...
              <Button
                ...
                className="w-full bg-purple-600 hover:bg-purple-700 hover:cursor-pointer text-white py-3 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25"
              >
                Ask a Question
              </Button>
            </div>
