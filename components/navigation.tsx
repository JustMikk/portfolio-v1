      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" aria-label="Nathan - Home">
              <h1 className="text-2xl font-bold text-foreground">Nathan.</h1>
            </Link>
          </div>
            ...
            <ul className="ml-10 flex items-baseline space-x-8" role="menubar">
              <li role="none">
                <Link
                  ...
                  className={`transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-background rounded-md px-2 py-1 ${
                    pathname === "/" ? "text-purple-400" : "text-muted-foreground hover:text-purple-400"
                  }`}
                  role="menuitem"
              ...
              <li role="none">
                <Link
                  href="/about"
                  className={`transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-background rounded-md px-2 py-1 ${
                    pathname === "/about" ? "text-purple-400" : "text-muted-foreground hover:text-purple-400"
                  }`}
                  role="menuitem"
              ...
              <li role="none">
                <Link
                  href="/portfolio"
                  className={`transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-background rounded-md px-2 py-1 ${
                    pathname === "/portfolio" ? "text-purple-400" : "text-muted-foreground hover:text-purple-400"
                  }`}
                  role="menuitem"
