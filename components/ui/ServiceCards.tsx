  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        ...
        <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-neutral-800 text-lg lg:text-xl dark:text-neutral-100">
          {title}
        </span>
      </div>
      <p className="text-neutral-600 text-base leading-relaxed lg:text-lg dark:text-neutral-300 max-w-xs relative z-10 px-10">
        {description}
      </p>
    </div>
  );
